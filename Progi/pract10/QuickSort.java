...
public class QuickSort {
    ...
    public static void main(String []args){
        ...
        iDNumber[0] =  new Student("artyom", 5);
        iDNumber[1] = new Student("vitalya", 15);
        iDNumber[2] =new Student("dmitry", 10);

        Student[] iDNumber2 = new Student[4];
        iDNumber2[0] =  new Student("mafutala", 8);
        iDNumber2[1] = new Student("adolf", 7);
        iDNumber2[2] =new Student("yana", 11);
        iDNumber2[3] =new Student("oleg", 13);
